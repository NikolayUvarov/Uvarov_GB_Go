...
func Calculate(expr string) (float64, error) {
	...
	// }
	/*
		if strings.ToLower(expr) == "help" {
			help()
			return 0, errors.New("Help called")
		}
	*/
...
func Help() {
	fmt.Println("Write here arbitrary expression")
	fmt.Println("You can use +-*/ operation")
	fmt.Println("And sqrt,(arc)sin,cos,tn; abs,ln,log functions")
}
